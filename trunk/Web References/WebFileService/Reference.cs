...
namespace zsi.PhotoFingCapture.WebFileService {
    ...
    public partial class WebFileManager : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public string VerifyBiometricsData(int UserId, int FingNo, [System.Xml.Serialization.XmlElementAttribute(DataType="base64Binary")] byte[] Data) {
        ...
        /// <remarks/>
        public void VerifyBiometricsDataAsync(int UserId, int FingNo, byte[] Data) {
            this.VerifyBiometricsDataAsync(UserId, FingNo, Data, null);
        }
        
        /// <remarks/>
        public void VerifyBiometricsDataAsync(int UserId, int FingNo, byte[] Data, object userState) {
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/police-records/WebFileServices/UploadFile2", RequestNamespace="http://tempuri.org/police-records/WebFileServices", ResponseNamespace="http://tempuri.org/police-records/WebFileServices", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public bool UploadFile2(int strUserId, string param, [System.Xml.Serialization.XmlElementAttribute(DataType="base64Binary")] byte[] image) {
            object[] results = this.Invoke("UploadFile2", new object[] {
                        strUserId,
                        param,
                        image});
            return ((bool)(results[0]));
        ...
        /// <remarks/>
        public void UploadFile2Async(int strUserId, string param, byte[] image) {
            this.UploadFile2Async(strUserId, param, image, null);
        }
        
        /// <remarks/>
        public void UploadFile2Async(int strUserId, string param, byte[] image, object userState) {
            ...
            this.InvokeAsync("UploadFile2", new object[] {
                        strUserId,
                        param,
                        image}, this.UploadFile2OperationCompleted, userState);
        }
        
        private void OnUploadFile2OperationCompleted(object arg) {
            if ((this.UploadFile2Completed != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.UploadFile2Completed(this, new UploadFile2CompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.5420")]
    public delegate void UploadFile2CompletedEventHandler(object sender, UploadFile2CompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.5420")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class UploadFile2CompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal UploadFile2CompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
